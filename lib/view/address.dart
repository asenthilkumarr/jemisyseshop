...
class AddressPage extends StatefulWidget{
  ...
  AddressPage({this.itemCount, this.totalAmount, this.itemList, this.masterScreenFormKey});
                                      ...
                                      Navigator.push(context, MaterialPageRoute(
                                          builder: (context) =>
                                              PaymentPage(itemCount: itemCount,
                                                ...
                                                dAddress: billingAddress, itemList: widget.itemList,dstoreCode: dstoreCode, masterScreenFormKey: widget.masterScreenFormKey,)));
                                    }
                                  },
                                ),
                              ),
                                ...
                                child: Container(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Row(
                                      mainAxisAlignment: MainAxisAlignment.center,
                                      children: [
                                        Text("SAVE", style: TextStyle(fontSize: 15, color: Colors.white),),
                                      ],
                                    ),
                                  ),
                                ),
